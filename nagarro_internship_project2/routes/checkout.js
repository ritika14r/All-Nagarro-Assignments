...
var NoOfOrder = require("../models/NoOfOrder");
...
router.post("/",isLoggedIn,function(req,res){
	NoOfOrder.findOne({},function(err,NoOfOrderObject) {
		if(err || !NoOfOrderObject) {
			req.flash("error","Something went wrong!!");
			res.redirect("/products");
		} else {
			NoOfOrderObject.count++;
			var no = NoOfOrderObject.count;
			NoOfOrderObject.save();
